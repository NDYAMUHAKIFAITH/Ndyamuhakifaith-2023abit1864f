...
(1, 1, 'Scripting languages', 'rerha', '2024-12-12'),
(2, 1, 'yesss', 'by the end of the day', '2024-12-12'),
(3, 1, 'yesss', 'by the end of the day', '2024-12-12');
...
INSERT INTO `courses` (`id`, `name`, `lecturer_id`, `description`) VALUES
(1, 'BIT', 2, 'YEAH'),
(2, 'BCS', 2, 'yeee');
...
(1, 'Ndyamuhaki faith', 'faith@gmail.com', 'faith', '$2y$10$PqrdzxFmAzCUtSRuAkLkJ.ehANSw0dQrHBvYyJb01LDtqc/xCJvMG', 'admin'),
(2, 'janet', 'janet@gmail.com', 'janet', '$2y$10$bG.CTc6NxfwD9mrPiTtnPu4.MbUFkIl.oICbZgk9HO2Hy6uTI3lq.', 'lecturer'),
(3, 'agnes', 'agnes@gmail.com', 'agnes', '$2y$10$eF80a95XEztNLl21kaKNiOGlUdAmnpJ1gFNRcKFh54jwJyk7I/Axi', 'student');
